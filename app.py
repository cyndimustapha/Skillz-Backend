...
api.add_resource(CourseContentResource, '/coursecontents', '/coursecontents/<int:course_id>')
api.add_resource(EnrollmentResource, '/enrollments', '/enrollments/<int:learner_id>')
